...
const char* ei_classifier_inferencing_categories[] = { "Kreis_blau", "Kreis_rot", "kreis_gruen", "quadrat_blau", "qudrat_gruen", "qudrat_rot", "unknown" };

ei_dsp_named_axis_t ei_dsp_config_9_named_axes[] = {
    { .name = "Image", .axis = 0 }
};
size_t ei_dsp_config_9_named_axes_size = 1;
EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_9_axes[] = { 0 };
const uint32_t ei_dsp_config_9_axes_size = 1;
ei_dsp_config_image_t ei_dsp_config_9 = {
    9, // uint32_t blockId
    1, // int implementationVersion
    1, // int length of axes
    ei_dsp_config_9_named_axes, // named axes
    ei_dsp_config_9_named_axes_size, // size of the named axes array
    "RGB" // select channels
};
...
const ei_impulse_t impulse_616709_0 = {
    .project_id = 616709,
    .project_owner = "Justin Dax",
    .project_name = "Conveyor Belt",
    .impulse_id = 1,
...
ei_impulse_handle_t impulse_handle_616709_0 = ei_impulse_handle_t( &impulse_616709_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_616709_0;
